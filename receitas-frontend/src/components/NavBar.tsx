    ...
    return (
        <div className=" shadow-md w-full top-0 left-0 text-white">
            <div className="  md:flex items-center justify-between  bg-transparent py-4 md:px-10 px-7 ">
                ...
                <div
                    className="text-3xl absolute right-8 text-white-300 top-6 cursor-pointer md:hidden"
          ...
          bg-transparent md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all 
                ...
                >
                    {links.map((link, index) => {
                        return (
                            <li
                                key={index}
                                className="text-white-400 md:ml-8 md:my-0 my-7 hover:text-blue-500"
                            >
